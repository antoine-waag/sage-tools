...
namespace AntoineWaag\SageTools\Database;
...
class TaxQuery
{
    ...
    public function add(string | self $taxonomyOrTaxQuery, string | int | array $terms, string $field = 'slug', string $operator = 'IN', bool $includeChildren = false)
    {
        $finalOperator = 'IN';
        $finalField    = 'slug';
