...
use AntoineWaag\SageTools\Database\TaxQuery;

abstract class AbstractRepository
{
    abstract public static function getBaseQueryBuilder(?int $perPage = null, int $page = 1): QueryBuilder;
    ...
    {
        $qb = static::getBaseQueryBuilder()->page($page);
